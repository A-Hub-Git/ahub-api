...
class AuthService {
    ...
    static forgetPassword({ id: userId, phone }) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                const token = Authorization_1.default.createHash('1234');
                try {
                    const isPasswordToken = yield this.findPasswordToken(userId);
                    if (!isPasswordToken) {
                        yield Services_1.QueueService.sendOTP(phone, '', userId);
    ...
    static verifyResetPassword(userId, token) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (user &&
                    Authorization_1.default.compareHash(token, user.token) &&
