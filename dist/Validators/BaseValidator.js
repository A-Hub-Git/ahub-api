...
class BaseValidator {
    static validator(data, rules, res, cb) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (validator.fails()) {
                BaseRequestHandle_1.default.setError(ResponseCode_1.HTTP_CODES.UN_PROCESSABLE_ENTITY, Object.values(validator.errors.errors)[0][0]);
    ...
    static validate(req, res, next) {
        ...
        BaseRequestHandle_1.default.setError(ResponseCode_1.HTTP_CODES.UN_PROCESSABLE_ENTITY, errors[0]);
