...
Authorization.VerifyUserToken = (roleIds) => (req, res, next) => {
    ...
    try {
        ...
        jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET, (error, payload) => __awaiter(void 0, void 0, void 0, function* () {
            if (error) {
                BaseRequestHandle_1.default.setError(ResponseCode_1.HTTP_CODES.UNAUTHORIZED, 'Unauthorized. Token Invalid');
            ...
            if (!user) {
                BaseRequestHandle_1.default.setError(ResponseCode_1.HTTP_CODES.UNAUTHORIZED, 'Unauthorized. User does not exist in our system');
                return BaseRequestHandle_1.default.send(res);
            }
            if (user &&
                roleIds &&
                ...
                BaseRequestHandle_1.default.setError(ResponseCode_1.HTTP_CODES.BAD_REQUEST, 'Access Denied, Unauthorized Access');
                return BaseRequestHandle_1.default.send(res);
            }
            req.user = user;
        }));
